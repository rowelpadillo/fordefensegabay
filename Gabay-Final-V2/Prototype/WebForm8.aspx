<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm8.aspx.cs" Inherits="Gabay_Final_V2.Prototype.WebForm8" %>
...
<body>
    ...
    <script type="text/javascript">
        // Function to scroll the CoursesAppended TextBox to the bottom
        function scrollToBottom() {
            var coursesAppended = document.getElementById('<%= CoursesAppended.ClientID %>');
            coursesAppended.scrollTop = coursesAppended.scrollHeight;
        }

        // Call the scrollToBottom function when the page loads or after an UpdatePanel partial postback

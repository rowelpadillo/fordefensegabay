<%@ Page Title="" Language="C#" MasterPageFile="~/Views/DashBoard/Department_Homepage/Department_Master.Master" AutoEventWireup="true" CodeBehind="Department_CampusInfo.aspx.cs" Inherits="Gabay_Final_V2.Views.Modules.Campus_Info.Department_CampusInfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    <link href="../../../Resources/CustomStyleSheet/CampusInfo/CampusInfoStyle.css" rel="stylesheet" />
    <%--    <div class="container">--%>
    <div class="accordion">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_login.aspx.cs" Inherits="Gabay_Final_V2.Views.LoginPages.Admin_login" %>
...
<body>
    <div class="container">
        <div class="row p-3">
            <div class="col-md-5 d-none d-md-block custom-bg4 shadow-lg">
                ...
                <form id="form1" runat="server">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="form-floating">
                            ...
                            <asp:TextBox ID="login_Pass" runat="server" CssClass="form-control" placeholder="password"></asp:TextBox>
